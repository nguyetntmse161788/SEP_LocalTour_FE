...
export const getComparator = (order: 'asc' | 'desc', orderBy: string) => (a: PlaceReportProps, b: PlaceReportProps) => {
  if (orderBy === 'status') {
...
export const applyFilter = ({
  ...
  inputData: PlaceReportProps[];
  comparator: (a: PlaceReportProps, b: PlaceReportProps) => number;
  filterName: string;
